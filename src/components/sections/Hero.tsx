...
function Hero() {
  return (
    <header className='py-section-padding bg-[url(/hero_bg_small.jpg)] md:bg-[url(/hero_bg_medium.jpg)] xl:bg-[url(/hero_bg_big.jpg)] bg-cover bg-center bg-no-repeat bg-fixed relative z-0 lg:h-screen text-white'>
        <Shadow />
        <Container>
